...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ["VANILLA_DB"],
        "USER": os.environ["VANILLA_USER"],
        "HOST": os.environ["VANILLA_HOST"],
        "PASSWORD": os.environ["VANILLA_PASSWORD"],
        "PORT": 5432,
    }
}
...
### IGNORABLE_404_URLS = []
INSTALLED_APPS = [
    "vanilla.nilla.apps.NillaConfig",
...
SETTINGS_MODULE = "vanilla.settings"  ###
